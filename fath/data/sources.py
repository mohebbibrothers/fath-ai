...
def get_source(name: str) -> DataSource:
    sources = {
        "kraken": KrakenSource(),
        "okx": OKXSource(),
        # OKX USDT-margined PERPETUAL FUTURES — what we actually trade.
        # Two aliases kept for compatibility with cached data filenames.
        "okx_swap": OKXSwapSource(),
        "okx_futures": OKXSwapSource(),
    }
